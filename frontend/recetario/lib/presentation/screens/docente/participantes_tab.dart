...
import '../../../core/constants/api_constants.dart'; // ✅ LÍNEA AGREGADA
...
class _ParticipantesTabState extends State<ParticipantesTab> {
  ...
  // ✅ FUNCIÓN CORREGIDA - USA ApiConstants.baseUrl EN LUGAR DE localhost
  Future<void> _exportarAExcel() async {
    ...
    try {
      ...
      // ✅ CORRECCIÓN: Usar ApiConstants en lugar de _getBaseUrl()
      final url = '${ApiConstants.baseUrl}${ApiConstants.exportarParticipantes(widget.curso.id)}';
      
      print('🔍 DEBUG - URL de exportación: $url'); // ✅ Para verificar en consola
